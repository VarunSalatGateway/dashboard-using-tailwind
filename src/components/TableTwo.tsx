...
const TableTwo = () => {
  return (
    <div className="rounded-md border h-[550px] pt-14 w-full overflow-x-hidden table-scrollbar border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
      ...
      {/* <div className="grid border-t border-stroke py-4.5 px-4 dark:border-strokedark grid-cols-6 md:grid-cols-8 md:px-6 2xl:px-7.5">
      ...
      {Array.from({ length: 10 }).map((_item, index) => (
        <div
          key={index}
          className="grid grid-cols-3 border-t border-stroke py-4.5 px-4 dark:border-strokedark md:grid-cols-7 md:px-6 2xl:px-7.5"
        >
          <div className="col-span-1 md:col-span-2 flex items-center">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
              <div className="hidden md:grid place-items-center h-10.5 w-10.5  overflow-hidden bg-body rounded-[50%]">
                <h4 className="text-white">S</h4>
              </div>
              <div>
          ...
          <div className="col-span-1 hidden items-center sm:flex flex-col">
            <h4 className="text-xl text-black dark:text-white">Time</h4>
            <p className="text-sm text-black dark:text-white">12:00 PM</p>
          </div>

          <div className="col-span-1 hidden md:flex items-center flex-col">
            <h4 className="text-xl text-black dark:text-white">Date</h4>
            <p className="text-sm text-black dark:text-white">02-04-2023</p>
          </div>
          <div className="col-span-1 flex items-center flex-col">
            <h4 className="text-xl text-black dark:text-white">Last Visit</h4>
            <p className="text-sm text-black dark:text-white">2 Days ago</p>
          </div>
          <div className="col-span-1 hidden md:flex items-center flex-col ">
            <h4 className="text-xl text-black dark:text-white">Total visit</h4>
            <p className="text-sm text-black dark:text-white">2 Times</p>
          </div>
          <div
